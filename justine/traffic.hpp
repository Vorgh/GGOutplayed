...
public:
    ...
    :m_size ( size ), m_catchdist ( catchdist ), m_type ( type ), m_minutes ( minutes )
  {
    ...
    faronk = "Naplo";
    faRonk = new std::fstream ( "/home/vorgh/robocar-emulator/" , std::ios_base::out );
        ...
        for ( auto car:m_smart_cars )
          {
		    ...
		    *faRonk << *car1 << "-es rendor jelentes: Elkaptam egy gangstert " << m_time << "-kor. Pozicio: " << lon1 << "," << lat1 << std::endl;
                  }
              }
          }
      }
