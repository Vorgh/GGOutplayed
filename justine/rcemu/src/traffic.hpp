...
public:
  ...
  Traffic (int mdelay, int size, const char * shm_segment, double catchdist, TrafficType type = TrafficType::NORMAL, int minutes = 10)
    :m_delay(mdelay), m_size ( size ), m_catchdist ( catchdist ), m_type ( type ), m_minutes ( minutes )
    {
