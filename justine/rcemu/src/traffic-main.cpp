...
int main ( int argc, char* argv[] )
{
  ...
  ( "mdelay", boost::program_options::value<int>(), "refresh rate" )
  ;
  ...
  justine::robocar::Traffic traffic {mdelay, nrcars, shm.c_str(), catchdist, type, minutes};
