...
public:
  ...
  void start ( boost::asio::io_service& io_service, const char * port, int number, int teamsize );
...
private:
  ...
  std::vector<Cop> initcops ( boost::asio::ip::tcp::socket & socket, int number, int teamsize );
